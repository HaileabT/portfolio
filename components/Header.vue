<template>
  <div id="welcome" class="w-full h-svh grid place-items-center">
    <nav class="top-10 fixed z-40 mix-blend-difference">
      <div class="flex gap-5">
        <a
          ...
          "
          class="pointer-grow relative group text-xl text-dark-normal-text hover:text-dark-header-text transition-all"
          >{{ link.text }}
          <span
    ...
    >
      <h1 class="text-dark-normal-text font-[Poppins] text-center text-5xl">
