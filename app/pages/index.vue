<template>
    <div
        ...
        <div
            class="relative z-1 bg-card w-full h-max my-auto max-w-[1200px] max-h-[650px] md:max-h-[800px] mx-auto flex flex-col gap-4 lg:gap-8 p-4 md:p-8 overflow-y-auto">
            <NuxtLink
            ...
            <div>
                <h1
                    class="text-foreground text-base md:text-lg lg:text-xl font-bold lowercase">
                    Haileab
                    Tesfaye
                </h1>
                <p
                    class="lowercase text-foreground/80 text-xs md:text-sm lg:text-base">
                    A
                    fullstack
                    engineer</p>
            ...
            <div class="flex gap-2 flex-col lg:flex-row w-full">
                <div
                    class="flex flex-col gap-2 w-full lg:w-1/2! text-sm lg:text-base ">
                    <h2>Experience</h2>
        ...
        <div
            ...
            <div class=" bg-card hidden md:block">
                <Skills />
            </div>
